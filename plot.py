...
def main():
    ...
    plt.legend(loc=4, fontsize=8)
    plt.title('NN RHC vs MSE', fontdict={'size': 16})
    plt.ylabel('Accuracy')
    plt.xlabel('MSE')
    plt.savefig('images/NN/RHC_MSE.png')
    plt.close()
    ...
    with open('Results/NN/SA_Train.csv') as csvfile:
        ...
        for row in readCSV:
            if i ==0:
                ...
                if i == 5 or i == 10 or i == 15 or i == 20 or i == 25 or i == 30 or i == 35 or i == 40 or i == 45 or i == 50 or i == 55:
                    rhc_iterations.append(float(row[0]))
                    rhc_accuracy.append(float(row[3]))
                    plt.plot(rhc_iterations, rhc_accuracy,
                             label=row[1])
    ...
    plt.legend(loc=4, fontsize=8)
    plt.title('NN Optimal SA(0.95) vs MSE', fontdict={'size': 16})
    plt.ylabel('Training Time')
    plt.xlabel('MSE')
    plt.savefig('images/NN/SA_MSE.png')
    plt.close()
    ...
    plt.legend(loc=4, fontsize=8)
    plt.title('NN Optimal GA(200/100/10) vs Accuracy', fontdict={'size': 16})
    plt.ylabel('Accuracy')
    plt.xlabel('Iterations')
    ...
    with open('Results/NN/GA_Train.csv') as csvfile:
        ...
        for row in readCSV:
            if i == 0:
                ...
                if i == 25:
                    rhc_iterations.append(float(row[0]))
                    rhc_accuracy.append(float(row[8]))
                    plt.plot(rhc_iterations, rhc_accuracy,
                             label='Train MSE')
                    i = i + 1
                elif i > 25:
    ...
    plt.legend(loc=4, fontsize=8)
    plt.title('NN Optimal GA(200/100/10) vs MSE', fontdict={'size': 16})
    plt.ylabel('Accuracy')
    plt.xlabel('MSE')
    plt.savefig('images/NN/GA_MSE.png')
    plt.close()
